...
export default {
  ...
  methods:{
    ...
    draw(){
      ...
      const _this=this
      setTimeout(function(){
        console.log("this is",test.allEntitiesAndRelations)
        _this.initialdraw(test.allEntitiesAndRelations.nodes,test.allEntitiesAndRelations.links,test.allEntitiesAndRelations.categories,'main')
      },3000)
    },
